...
df_out_clean_roster <- df_updating_sm_parents_roster$updated_sm_parents %>% 
  ...
  mutate(i.type_of_work_done = case_when(type_of_work_done %in% c("1", "4", "5", "26", "30", "50") ~ "1", # food sector
                                         ...
                                         type_of_work_done %in% c("2", "3", "6", "9", "10", "15", "16", "17", "18", "21", "24", "25", "27",
                                                                  "32", "33", "36", "37", "45", "46", "47", "49", "52") ~ "4",
                                         type_of_work_done %in% c("19", "23") ~ "5",
                                         type_of_work_done %in% c("31") ~ "6",
                                         type_of_work_done %in% c("34", "35", "41", "44") ~ "7",
                                         type_of_work_done %in% c("29") ~ "8",
...
df_added_categories <- tibble::tribble(
  ...
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "29 - Teaching",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "30 - Cashier",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "31 - Mine worker",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "32 - Nail technician",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "33 - Forces",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "34 - Construction",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "35 - Carpentery and Joinery",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "36 - Photographer",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "37 - Printing Shop",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "38 - Genal finance",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "39 - Leather works",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "40 - Farmer",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "41 - Builder",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "42 - Factory worker",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "43 - Milling",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "44 - Construction worker",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "45 - Electronics and Electrician",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "46 - Filling station",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "47 - Cobbler",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "48 - Horticulture",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "49 - General worker",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "50 - Kapana seller",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "51 - Money lending",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "52 - Government employee",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "53 - Boutique",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "54 - Crafts and Netting",
  "type_of_work_done",                                                     "DP1.7 Type of main work done",                          "55 - General manufacture",
  ...
  "i.type_of_work_done",                                                     "DP1.7 Type of main work done",                          "6 - Mining",
  "i.type_of_work_done",                                                     "DP1.7 Type of main work done",                          "7 - Construction",
