...
# main data
clean_data_nms <- names(readxl::read_excel(path = clean_loc_data, n_max = 300, sheet = "cleaned_data"))
...
# loops
# roster
clean_data_nms_r_roster <- names(readxl::read_excel(path = clean_loc_data, n_max = 300, sheet = "cleaned_roster"))
